...
class NumericStats(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, min, max, avg, count, *args, **kwargs):  # noqa: E501
        """NumericStats - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, min, max, avg, count, *args, **kwargs):  # noqa: E501
        """NumericStats - a model defined in OpenAPI
