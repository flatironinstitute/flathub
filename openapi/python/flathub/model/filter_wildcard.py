...
class FilterWildcard(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, wildcard, *args, **kwargs):  # noqa: E501
        """FilterWildcard - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, wildcard, *args, **kwargs):  # noqa: E501
        """FilterWildcard - a model defined in OpenAPI
