...
class FieldStatsOneOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, others, terms, *args, **kwargs):  # noqa: E501
        """FieldStatsOneOf - a model defined in OpenAPI

        Args:
            others (int): number of rows with values not included in the top terms
            terms ([TopTerm]): top terms in descending order of count
    ...
    @convert_js_args_to_python_args
    def __init__(self, others, terms, *args, **kwargs):  # noqa: E501
        """FieldStatsOneOf - a model defined in OpenAPI
