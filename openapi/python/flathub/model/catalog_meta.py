...
class CatalogMeta(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, title, synopsis, descr, order, *args, **kwargs):  # noqa: E501
        """CatalogMeta - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, title, synopsis, descr, order, *args, **kwargs):  # noqa: E501
        """CatalogMeta - a model defined in OpenAPI
