...
from flathub import rest
from flathub.configuration import Configuration
from flathub.exceptions import ApiTypeError, ApiValueError, ApiException
from flathub.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.attachment  # this is an instance of the class Endpoint
        api_instance.attachment()  # this invokes api_instance.attachment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.attachment.callable or self.callable in this class
