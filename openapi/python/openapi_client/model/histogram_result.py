...
class HistogramResult(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'buckets': ([Bucket],),  # noqa: E501
            'sizes': ([float],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, buckets, sizes, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, buckets, sizes, *args, **kwargs):  # noqa: E501
        """HistogramResult - a model defined in OpenAPI
