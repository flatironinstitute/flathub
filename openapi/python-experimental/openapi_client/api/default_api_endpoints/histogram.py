...
FieldsSchema = HistogramList
QuartilesSchema = StrSchema
...
request_query_quartiles = api_client.QueryParameter(
    name="quartiles",
    style=api_client.ParameterStyle.FORM,
    schema=QuartilesSchema,
    explode=True,
)
# path params
        ...
        class _items(
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict, ],
                quartiles: typing.Union[quartiles, Unset] = unset,
...
class Histogram(api_client.Api):
